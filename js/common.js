...
function initQuestion() {
    questions.forEach(function(q, i) {
        ...
        str += '        <img src="http://gaeyoucom2.cdn3.cafe24.com/president/img/q' + i + '.png" alt="title" style="height:30px">'
        str += '        <img src="http://gaeyoucom2.cdn3.cafe24.com/president/img/question.png" alt="title" style="height:30px">'
        str += '    </h1>'
        ...
        str += '                <img src="http://gaeyoucom2.cdn3.cafe24.com/president/img/source/' + q[0].image + '" class="card-img-top" alt="...">'
        ...
        str += '            <div class="card" style="width: ">'
        str += '                <img src="http://gaeyoucom2.cdn3.cafe24.com/president/img/source/' + q[1].image + '" class="card-img-top" alt="...">'
        str += '                <div class="card-body">'
